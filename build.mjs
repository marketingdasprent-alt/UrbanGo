...
const footer=`<footer class="site-footer"><div class="container footer-grid"><div class="footer-about"><a class="brand brand-footer" href="/"><img src="/assets/images/urbango-logo.png" width="52" height="52" alt=""><span>Urban<span>GO</span></span></a><p>Mobilidade e logística em Portugal.<br>TVDE, entrega expresso e aluguer de viaturas.</p></div><div><h2>Motoristas</h2><a href="/motoristas/">Começar</a><a href="/requisitos-tvde/">Requisitos</a><a href="/como-funciona/">Como funciona</a></div><div><h2>Empresa</h2><a href="/sobre/">Sobre</a><a href="/contactos/">Contactos</a><a href="/faq/">FAQ</a></div><div><h2>Legal</h2><a href="/legal/privacidade.html">Privacidade</a><a href="/legal/cookies.html">Cookies</a><a href="/legal/termos.html">Informação legal</a><button class="link-button" data-cookie-settings>Gerir cookies</button></div><div class="footer-contact"><h2>Contactos</h2><span>Telefone</span><a href="tel:+351910128228">+351 910 128 228</a><span>Email</span><a href="mailto:geral@urbango.pt">geral@urbango.pt</a></div></div><div class="container footer-bottom"><span>© <span data-year></span> UrbanGO. Todos os direitos reservados.</span><span>Operador TVDE licenciado pelo IMT</span></div></footer>`;
